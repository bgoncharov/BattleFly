...
class PlayerPlane: SKSpriteNode {
    ...
    let animationSpriteStride = [(13, 1, -1), (13, 26, 1), (13, 13, 1)]
    ...
    func performFly() {
        ...
        let planeSequence = SKAction.sequence([plainWaitAction, planeDirectionCheckAction])
    ...
    fileprivate func preloadTextureArrays() {
        for i in 0...2 {
            self.preloadArray(_stride: animationSpriteStride[i]) { [unowned self] array in
                switch i {
